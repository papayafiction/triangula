...
public class Level3 extends BaseLevel implements Level,Serializable {
    ...
    public Level3() {
        try {
            GameImpl.setNextLevel(Class.forName("de.sopamo.triangula.android.levels.Level4"));
    ...
    public void end() {
        image = null;
        Games.Achievements.unlockImmediate(GameActivity.getGoogleApiClient(),GameActivity.getInstance().getString(R.string.achievement_level_3));
